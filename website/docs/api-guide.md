...
named sequence, or the named artifact family; two artifacts at one sequence
must be told apart with `--platform`), prints the listing as consent facts and
