...
def add_model_search_path(path: Path) -> None:
    ...
    """
    global SKULK_MODELS_PATH, SKULK_MODELS_PATH  # noqa: PLW0603
...
SKULK_MUSIC_OUTPUT_DIR = SKULK_CACHE_HOME / "music_output"
SKULK_MUSIC_STORE_DIR = SKULK_CACHE_HOME / "music"
