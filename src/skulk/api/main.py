    ...
    def _setup_routes(self) -> None:
        ...
        self.app.post(
            ...
            description=(
                ...
                "result against its output schema after. The response is "
                "always a typed result: failures arrive as machine-readable "
                "error codes (not_found, version_mismatch, revision_mismatch, "
                "invalid_payload, invalid_result, payload_too_large, "
                "overloaded, timeout, provider_error) rather than transport "
                "errors. Callers normally use this through their extension "
