...
async def test_web_search_returns_structured_results(
    ...
    monkeypatch.setattr("skulk.api.main.default_browser_tool_provider", lambda: _FakeProvider())
...
async def test_web_search_wraps_provider_failures(
    ...
    monkeypatch.setattr(
        "skulk.api.main.default_browser_tool_provider", lambda: _FailingProvider()
    )
...
async def test_open_url_wraps_invalid_urls_as_bad_request(
    ...
    monkeypatch.setattr(
        "skulk.api.main.default_browser_tool_provider", lambda: _InvalidUrlProvider()
    )
