...
from skulk.shared.types.chunks import ErrorChunk, ImageChunk
...
def _send_image_chunk(
    ...
    data_chunks = [
        encoded_data[i : i + SKULK_MAX_CHUNK_SIZE]
        for i in range(0, len(encoded_data), SKULK_MAX_CHUNK_SIZE)
    ]
