...
from skulk.worker.engines.mlx.generator.generate import mlx_generate
from skulk.worker.engines.mlx.utils_mlx import apply_chat_template, shard_and_load
...
DISTRIBUTED_TEST_CONFIG = PipelineTestConfig(
    model_path=SKULK_MODELS_DIR / DISTRIBUTED_TEST_MODEL.directory_name,
