...
from skulk.worker.engines.mlx.generator.generate import extract_top_logprobs
from skulk.worker.engines.mlx.patches.opt_batch_gen import (
...
class TestBatchedTopKPrecompute:
    ...
    def _reset_globals(self) -> None:
        import skulk.worker.engines.mlx.patches.opt_batch_gen as _mod
