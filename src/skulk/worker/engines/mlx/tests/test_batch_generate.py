...
import skulk.worker.engines.mlx.generator.batch_generate  # noqa: F401
from skulk.shared.types.mlx import Model
from skulk.worker.engines.mlx.cache import encode_prompt, make_kv_cache
from skulk.worker.engines.mlx.generator.generate import prefill
...
def test_exo_batch_generator_end_to_end() -> None:
    """Drive SkulkBatchGenerator through submit -> step -> completion.
