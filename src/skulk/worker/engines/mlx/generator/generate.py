...
from skulk.shared.models.model_cards import ModelCard, multi_node_speculation_disabled
from skulk.shared.tracing import TraceAttrValue, record_trace_marker, trace
...
def _should_use_native_vision_reference_path() -> bool:
    ...
    """
    override = os.environ.get("SKULK_NATIVE_VISION_REFERENCE_PATH")
