...
function computePlacement(
  ...
  const placementNodes: PlacementNode[] = ids.map((id, i) => {
    ...
    // Exclusion overrides the API-preview signal: regardless of which nodes
    // the cached preview happened to pick, an operator-excluded node is
    // never "used" for this placement and renders dimmed.
