...
# mlx-lm 0.31.3 split the monolithic BatchGenerator into a prompt-processing
# batch, a generation batch, and a thin orchestrator. These stubs mirror the
# 0.31.3 surface that Skulk consumes (batch_generate.py).
...
class BatchGenerator:
    ...
    _unprocessed_sequences: deque[Any]
    _prompt_batch: PromptProcessingBatch
    _generation_batch: GenerationBatch
    _prompt_tokens_counter: int
    _prompt_time_counter: float
    ...
    def insert(
        ...
        state_machines: Optional[List[Any]] = ...,
    ) -> List[int]: ...
    def insert_segments(
        self,
    ...
    def stats(self, stats: Optional[BatchStats] = ...) -> Any: ...
    def next(
        self,
    ) -> Tuple[
